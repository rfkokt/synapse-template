    ...
    <div className="space-y-6">
      ...
      <Card variant="bordered" className="bg-white">
        <CardContent className="p-8 space-y-6">
          <div>
            <h2 className="text-xl font-bold text-neutral-900 mb-2">🔌 UI Kit & Verdaccio Showcase</h2>
            <p className="text-sm text-neutral-500 mb-4">
              If the buttons below are properly styled, it means <code className="bg-neutral-100 px-1 rounded">@synapse/ui-kit</code> is successfully loaded from your shared library registry!
            </p>
          </div>
